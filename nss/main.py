...
database_path = 'D:/configs/Canteen-Meal-Notifer-Vidyalaya/nss/canteen.db'
...
def getFood():
    ...
    if driver.current_url == 'https://nhss.onlinevidyalaya.net/Pages/BaseFramework/Security/Login.aspx?OrgGroupId=1965' or driver.title == 'Login':
        print('Login Page')
        driver.find_element(By.ID, 'userNameTextBox').send_keys('24351B')
        driver.find_element(By.ID, 'passwordTextBox').send_keys('524248')
